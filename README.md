...
* [fhEVM](https://github.com/zama-ai/fhevm) ⭐ 25,075 | 🐛 118 | 🌐 Rust | 📅 2026-08-13 - Solidity library that enables confidential smart contracts on the Ethereum VM using FHE.
* <a name="SEAL">[Microsoft SEAL](https://github.com/microsoft/SEAL) ⭐ 4,006 | 🐛 118 | 🌐 C++ | 📅 2026-08-04 - C++ FHE library implementing BFV and CKKS schemes.</a>
* <a name="HElib">[HElib](https://github.com/HomEnc/HElib) ⭐ 3,246 | 🐛 194 | 🌐 C++ | 📅 2024-08-01 - BGV scheme with bootstrapping and the Approximate Number CKKS scheme.
* [TFHE-rs](https://github.com/zama-ai/tfhe-rs) ⭐ 1,640 | 🐛 44 | 🌐 Rust | 📅 2026-08-13 - Rust implementation of the TFHE scheme for boolean and integers FHE arithmetics by [Zama](https://github.com/zama-ai).
...
* <a name="tfhe">[tfhe](https://github.com/tfhe/tfhe) ⭐ 1,324 | 🐛 46 | 🌐 C++ | 📅 2025-09-17 - Faster fully HE: Bootstrapping in less than 0.1 seconds.</a>
* <a name="OpenFHE">[OpenFHE](https://github.com/openfheorg/openfhe-development) ⭐ 1,174 | 🐛 96 | 🌐 C++ | 📅 2026-08-13 - C++ FHE library implementing all major schemes along with bootstrapping and scheme switching.
* [TenSEAL](https://github.com/OpenMined/TenSEAL) ⭐ 1,034 | 🐛 135 | 🌐 C++ | 📅 2026-08-04 - Library for HE operations on tensors, built on [Microsoft SEAL](#SEAL), with a Python API.
...
* [Google's FHE Repository](https://github.com/google/fully-homomorphic-encryption) ⭐ 3,643 | 🐛 1 | 🌐 Starlark | 📅 2026-08-12 - A compiler that converts a subset of C++ programs into FHE circuits implemented in various backend libraries (superseded by [HEIR](#HEIR)).
...
* <a name="HEIR">[HEIR](https://github.com/google/heir) ⭐ 764 | 🐛 364 | 🌐 MLIR | 📅 2026-08-13 - Google's MLIR-based toolchain for FHE compilers.
...
* [OpenFHE demo applications](https://github.com/openfheorg/openfhe-development) ⭐ 1,174 | 🐛 96 | 🌐 C++ | 📅 2026-08-13 - Several demo applications that demonstrate some of the capabilities of OpenFHE
...
* [OpenMined](https://github.com/OpenMined) - Decentralized data ownership & intelligence based on HE and deep / federated learning.
  * [PySyft](https://github.com/OpenMined/PySyft) ⭐ 9,938 | 🐛 21 | 🌐 Python | 📅 2026-08-12 - Python library for the server/IoT part of the OpenMined's open-source ecosystem.
...
* [awesome-cryptography](https://github.com/sobolevn/awesome-cryptography) ⭐ 7,063 | 🐛 71 | 📅 2026-07-15
* [awesome-crypto-papers](https://github.com/pFarb/awesome-crypto-papers) ⭐ 2,086 | 🐛 4 | 📅 2024-10-17
