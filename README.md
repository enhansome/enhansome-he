...
* [fhEVM](https://github.com/zama-ai/fhevm) ⭐ 24,949 | 🐛 121 | 🌐 Rust | 📅 2026-08-15 - Solidity library that enables confidential smart contracts on the Ethereum VM using FHE.
* <a name="SEAL">[Microsoft SEAL](https://github.com/microsoft/SEAL) ⭐ 4,007 | 🐛 118 | 🌐 C++ | 📅 2026-08-04 - C++ FHE library implementing BFV and CKKS schemes.</a>
* <a name="HElib">[HElib](https://github.com/HomEnc/HElib) ⭐ 3,247 | 🐛 194 | 🌐 C++ | 📅 2024-08-01 - BGV scheme with bootstrapping and the Approximate Number CKKS scheme.
* [TFHE-rs](https://github.com/zama-ai/tfhe-rs) ⭐ 1,642 | 🐛 44 | 🌐 Rust | 📅 2026-08-14 - Rust implementation of the TFHE scheme for boolean and integers FHE arithmetics by [Zama](https://github.com/zama-ai).
* <a name="lattigo">[lattigo](https://github.com/ldsec/lattigo) ⭐ 1,438 | 🐛 7 | 🌐 Go | 📅 2026-06-16 - Go library for lattice-based crypto that implements various schemes.
* <a name="tfhe">[tfhe](https://github.com/tfhe/tfhe) ⭐ 1,325 | 🐛 46 | 🌐 C++ | 📅 2025-09-17 - Faster fully HE: Bootstrapping in less than 0.1 seconds.</a>
* <a name="OpenFHE">[OpenFHE](https://github.com/openfheorg/openfhe-development) ⭐ 1,175 | 🐛 94 | 🌐 C++ | 📅 2026-08-14 - C++ FHE library implementing all major schemes along with bootstrapping and scheme switching.
* [TenSEAL](https://github.com/OpenMined/TenSEAL) ⭐ 1,033 | 🐛 136 | 🌐 C++ | 📅 2026-08-04 - Library for HE operations on tensors, built on [Microsoft SEAL](#SEAL), with a Python API.
* [python-paillier](https://github.com/data61/python-paillier) ⭐ 639 | 🐛 23 | 🌐 Python | 📅 2023-08-04 - Partially HE based on Paillier scheme.
* [Pyfhel](https://github.com/ibarrond/Pyfhel) ⭐ 550 | 🐛 7 | 🌐 Cython | 📅 2025-08-21 - A Python wrapper for [SEAL](#SEAL), [HElib](#HElib), and [PALISADE](#PALISADE).
...
* [Sunscreen](https://github.com/Sunscreen-tech/Sunscreen) ⭐ 307 | 🐛 16 | 🌐 Rust | 📅 2025-08-31 - Rust compiler for the BFV fully homomorphic encryption scheme.
...
* [node-seal](https://github.com/morfix-io/node-seal) ⭐ 216 | 🐛 0 | 🌐 TypeScript | 📅 2025-11-09 - JavaScript/WebAssembly port of [Microsoft SEAL](#SEAL).
* [cuHE](https://github.com/vernamlab/cuHE) ⭐ 212 | 🐛 4 | 🌐 Cuda | 📅 2017-06-08 - GPU-accelerated HE library for NVIDIA CUDA-Enabled GPUs.
* [NFLlib](https://github.com/quarkslab/NFLlib) ⭐ 182 | 🐛 10 | 🌐 C++ | 📅 2022-10-14 - NTT-based Fast Lattice library specialized on power-of-two polynomials.
* <a name="OpenFHE-Python">[OpenFHE-Python](https://github.com/openfheorg/openfhe-python) ⭐ 160 | 🐛 13 | 🌐 C++ | 📅 2026-05-19 - Python wrapper for [OpenFHE](#OpenFHE).
* [PhantomFHE](https://github.com/encryptorion-lab/phantom-fhe) ⭐ 159 | 🐛 7 | 🌐 Cuda | 📅 2025-01-01 - A CUDA-Accelerated Fully Homomorphic Encryption Library.
* [HEonGPU](https://github.com/Alisah-Ozcan/HEonGPU) ⭐ 137 | 🐛 7 | 🌐 Cuda | 📅 2026-05-11 -  CUDA-accelerated FHE library on GPUs (BFV, CKKS, MPC).
...
* [LightPHE](https://github.com/serengil/LightPHE) ⭐ 105 | 🐛 0 | 🌐 Python | 📅 2026-05-13 - A Python wrapping Partially HE library (RSA, ElGamal, Paillier, Damgard-Jurik, Benaloh, and more).
...
* <a name="OpenFHE-Rust">[OpenFHE-Rust](https://github.com/fairmath/openfhe-rs) ⭐ 58 | 🐛 8 | 🌐 C++ | 📅 2025-02-26 - Rust wrapper for [OpenFHE](#OpenFHE).
...
* [HEAAN-Python](https://github.com/Huelse/HEAAN-Python) ⭐ 32 | 🐛 5 | 🌐 C++ | 📅 2020-08-27 - Python binding for the [HEANN](#HEAAN) library.
...
* [Google's FHE Repository](https://github.com/google/fully-homomorphic-encryption) ⭐ 3,664 | 🐛 1 | 🌐 Starlark | 📅 2026-08-14 - A compiler that converts a subset of C++ programs into FHE circuits implemented in various backend libraries (superseded by [HEIR](#HEIR)).
* [Concrete](https://github.com/zama-ai/concrete) ⭐ 1,572 | 🐛 56 | 🌐 C++ | 📅 2025-12-19 - TFHE compiler for converting Python programs into FHE equivalents.
* [Concrete-ML](https://github.com/zama-ai/concrete-ml) ⭐ 1,445 | 🐛 21 | 🌐 Python | 📅 2026-08-04 - Python-based toolkit for data scientists w/o prior FHE knowledge (using sklearn, pyTorch, XGBoost models).
* <a name="HEIR">[HEIR](https://github.com/google/heir) ⭐ 808 | 🐛 366 | 🌐 MLIR | 📅 2026-08-15 - Google's MLIR-based toolchain for FHE compilers.
* [Cingulata](https://github.com/CEA-LIST/Cingulata) ⭐ 410 | 🐛 4 | 🌐 C++ | 📅 2025-06-13 - Compiler toolchain and RTE for running C++ programs over encrypted data.
* [EVA](https://github.com/microsoft/EVA) ⭐ 260 | 🐛 32 | 🌐 C++ | 📅 2024-07-03 - A compiler and optimizer for the CKKS scheme (targeting [Microsoft SEAL](#SEAL)).
...
* [IBM HElayers](https://github.com/IBM/helayers) ⭐ 47 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-06-30 - IBM's FHE SDK for practical and efficient execution of encrypted workloads.
...
* [tf-encrypted](https://github.com/tf-encrypted/tf-encrypted) ⭐ 1,243 | 🐛 144 | 🌐 Python | 📅 2024-09-25 - Bridge between TensorFlow and the [Microsoft SEAL](#SEAL) library.
* [OpenFHE demo applications](https://github.com/openfheorg/openfhe-development) ⭐ 1,175 | 🐛 94 | 🌐 C++ | 📅 2026-08-14 - Several demo applications that demonstrate some of the capabilities of OpenFHE
...
* [OpenMined](https://github.com/OpenMined) - Decentralized data ownership & intelligence based on HE and deep / federated learning.
  * [PySyft](https://github.com/OpenMined/PySyft) ⭐ 9,937 | 🐛 21 | 🌐 Python | 📅 2026-08-14 - Python library for the server/IoT part of the OpenMined's open-source ecosystem.
...
* [awesome-cryptography](https://github.com/sobolevn/awesome-cryptography) ⭐ 7,067 | 🐛 72 | 📅 2026-07-15
* [awesome-crypto-papers](https://github.com/pFarb/awesome-crypto-papers) ⭐ 2,087 | 🐛 4 | 📅 2024-10-17
* [awesome-mpc](https://github.com/rdragos/awesome-mpc) ⭐ 1,988 | 🐛 7 | 📅 2026-07-24 - Multi-Party Computation.
...
✨ Star this project on GitHub [![GitHub Repo stars](https://img.shields.io/github/stars/jonaschn/awesome-he?style=social)](https://github.com/jonaschn/awesome-he) ⭐ 1,256 | 🐛 9 | 📅 2025-03-25

🚀 Contribute further [awesome HE](https://github.com/jonaschn/awesome-he/edit/master/README.md) ⭐ 1,256 | 🐛 9 | 📅 2025-03-25 projects
