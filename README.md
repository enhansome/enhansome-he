...
* [fhEVM](https://github.com/zama-ai/fhevm) ⭐ 24,826 | 🐛 115 | 🌐 Rust | 📅 2026-09-08 - Solidity library that enables confidential smart contracts on the Ethereum VM using FHE.
* <a name="SEAL">[Microsoft SEAL](https://github.com/microsoft/SEAL) ⭐ 4,028 | 🐛 113 | 🌐 C++ | 📅 2026-08-28 - C++ FHE library implementing BFV and CKKS schemes.</a>
...
* [TFHE-rs](https://github.com/zama-ai/tfhe-rs) ⭐ 1,656 | 🐛 54 | 🌐 Rust | 📅 2026-09-08 - Rust implementation of the TFHE scheme for boolean and integers FHE arithmetics by [Zama](https://github.com/zama-ai).
...
* <a name="OpenFHE">[OpenFHE](https://github.com/openfheorg/openfhe-development) ⭐ 1,195 | 🐛 108 | 🌐 C++ | 📅 2026-09-08 - C++ FHE library implementing all major schemes along with bootstrapping and scheme switching.
* [TenSEAL](https://github.com/OpenMined/TenSEAL) ⭐ 1,036 | 🐛 135 | 🌐 C++ | 📅 2026-09-07 - Library for HE operations on tensors, built on [Microsoft SEAL](#SEAL), with a Python API.
...
* [LightPHE](https://github.com/serengil/LightPHE) ⭐ 106 | 🐛 0 | 🌐 Python | 📅 2026-09-03 - A Python wrapping Partially HE library (RSA, ElGamal, Paillier, Damgard-Jurik, Benaloh, and more).
...
* <a name="HEIR">[HEIR](https://github.com/google/heir) ⭐ 888 | 🐛 372 | 🌐 MLIR | 📅 2026-09-08 - Google's MLIR-based toolchain for FHE compilers.
...
* [OpenFHE demo applications](https://github.com/openfheorg/openfhe-development) ⭐ 1,195 | 🐛 108 | 🌐 C++ | 📅 2026-09-08 - Several demo applications that demonstrate some of the capabilities of OpenFHE
...
* [OpenMined](https://github.com/OpenMined) - Decentralized data ownership & intelligence based on HE and deep / federated learning.
  * [PySyft](https://github.com/OpenMined/PySyft) ⭐ 10,028 | 🐛 9 | 🌐 Python | 📅 2026-09-08 - Python library for the server/IoT part of the OpenMined's open-source ecosystem.
...
* [awesome-cryptography](https://github.com/sobolevn/awesome-cryptography) ⭐ 7,104 | 🐛 75 | 📅 2026-07-15
