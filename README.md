...
* [fhEVM](https://github.com/zama-ai/fhevm) ⭐ 24,818 | 🐛 116 | 🌐 Rust | 📅 2026-09-07 - Solidity library that enables confidential smart contracts on the Ethereum VM using FHE.
* <a name="SEAL">[Microsoft SEAL](https://github.com/microsoft/SEAL) ⭐ 4,026 | 🐛 113 | 🌐 C++ | 📅 2026-08-28 - C++ FHE library implementing BFV and CKKS schemes.</a>
...
* [TFHE-rs](https://github.com/zama-ai/tfhe-rs) ⭐ 1,653 | 🐛 60 | 🌐 Rust | 📅 2026-09-07 - Rust implementation of the TFHE scheme for boolean and integers FHE arithmetics by [Zama](https://github.com/zama-ai).
* <a name="lattigo">[lattigo](https://github.com/ldsec/lattigo) ⭐ 1,443 | 🐛 11 | 🌐 Go | 📅 2026-06-16 - Go library for lattice-based crypto that implements various schemes.
* <a name="tfhe">[tfhe](https://github.com/tfhe/tfhe) ⭐ 1,330 | 🐛 46 | 🌐 C++ | 📅 2025-09-17 - Faster fully HE: Bootstrapping in less than 0.1 seconds.</a>
* <a name="OpenFHE">[OpenFHE](https://github.com/openfheorg/openfhe-development) ⭐ 1,194 | 🐛 101 | 🌐 C++ | 📅 2026-09-06 - C++ FHE library implementing all major schemes along with bootstrapping and scheme switching.
* [TenSEAL](https://github.com/OpenMined/TenSEAL) ⭐ 1,035 | 🐛 135 | 🌐 C++ | 📅 2026-09-07 - Library for HE operations on tensors, built on [Microsoft SEAL](#SEAL), with a Python API.
* [python-paillier](https://github.com/data61/python-paillier) ⭐ 640 | 🐛 23 | 🌐 Python | 📅 2023-08-04 - Partially HE based on Paillier scheme.
* [Pyfhel](https://github.com/ibarrond/Pyfhel) ⭐ 553 | 🐛 7 | 🌐 Cython | 📅 2026-08-31 - A Python wrapper for [SEAL](#SEAL), [HElib](#HElib), and [PALISADE](#PALISADE).
...
* <a name="OpenFHE-Python">[OpenFHE-Python](https://github.com/openfheorg/openfhe-python) ⭐ 162 | 🐛 13 | 🌐 C++ | 📅 2026-05-19 - Python wrapper for [OpenFHE](#OpenFHE).
...
* [LightPHE](https://github.com/serengil/LightPHE) ⭐ 105 | 🐛 0 | 🌐 Python | 📅 2026-09-03 - A Python wrapping Partially HE library (RSA, ElGamal, Paillier, Damgard-Jurik, Benaloh, and more).
...
* [Google's FHE Repository](https://github.com/google/fully-homomorphic-encryption) ⭐ 3,760 | 🐛 4 | 🌐 Starlark | 📅 2026-09-06 - A compiler that converts a subset of C++ programs into FHE circuits implemented in various backend libraries (superseded by [HEIR](#HEIR)).
...
* <a name="HEIR">[HEIR](https://github.com/google/heir) ⭐ 887 | 🐛 372 | 🌐 MLIR | 📅 2026-09-07 - Google's MLIR-based toolchain for FHE compilers.
...
* [EVA](https://github.com/microsoft/EVA) ⭐ 262 | 🐛 32 | 🌐 C++ | 📅 2024-07-03 - A compiler and optimizer for the CKKS scheme (targeting [Microsoft SEAL](#SEAL)).
...
* [OpenFHE demo applications](https://github.com/openfheorg/openfhe-development) ⭐ 1,194 | 🐛 101 | 🌐 C++ | 📅 2026-09-06 - Several demo applications that demonstrate some of the capabilities of OpenFHE
...
* [OpenMined](https://github.com/OpenMined) - Decentralized data ownership & intelligence based on HE and deep / federated learning.
  * [PySyft](https://github.com/OpenMined/PySyft) ⭐ 10,027 | 🐛 21 | 🌐 Python | 📅 2026-09-07 - Python library for the server/IoT part of the OpenMined's open-source ecosystem.
...
* [awesome-cryptography](https://github.com/sobolevn/awesome-cryptography) ⭐ 7,102 | 🐛 74 | 📅 2026-07-15
* [awesome-crypto-papers](https://github.com/pFarb/awesome-crypto-papers) ⭐ 2,094 | 🐛 4 | 📅 2024-10-17
